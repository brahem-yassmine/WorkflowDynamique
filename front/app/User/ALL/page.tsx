        ...
        >
            ...
            <section className="relative overflow-hidden bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <button
                        onClick={() => router.push('/User/create?fresh=true')}
                        className="px-10 py-5 bg-indigo-600 text-white rounded-2xl font-black text-[11px] uppercase tracking-widest hover:bg-indigo-500 transition-all shadow-xl shadow-indigo-900/40 active:scale-95 flex items-center gap-3"
                    >
                        <Plus size={18} />
                        Create New Workflow
                    </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {isLoading ? (
                        ...
                        >
                            ...
                            <div className="mt-8 pt-6 border-t border-slate-50 space-y-4">
                                ...
                                <div className="flex gap-3">
                                    <button 
                                        onClick={() => router.push(`/User/create?id=${workflow._id}`)}
                                        className="flex-[3] py-4 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-600 transition-all flex items-center justify-center gap-2 group/btn"
                                    >
                                        Open Architect
                                    ...
                                    <button 
                                        ...
                                        className="flex-1 py-4 bg-slate-50 text-slate-300 hover:text-rose-600 hover:bg-rose-50 rounded-2xl flex items-center justify-center transition-all"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                </div>
                    ...
                    <div className="col-span-full py-32 bg-white rounded-[3rem] border border-dashed border-slate-100 text-center shadow-inner">

    ...
    <div className="min-h-screen bg-gray-50/50 pb-20 -m-8">
      ...
      <div className="bg-white border-b border-gray-100 sticky top-0 z-30 mb-10 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              onClick={() => router.push('/admin/AllKanban')}
              className="p-2.5 bg-slate-50 text-slate-400 hover:text-indigo-600 rounded-xl hover:bg-indigo-50 transition-all border border-transparent hover:border-indigo-100 outline-none"
          ...
          <button
            ...
            className="flex items-center gap-3 px-8 py-3 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl hover:bg-indigo-700 active:scale-95 transition-all shadow-xl shadow-indigo-100 disabled:opacity-50 border-0 outline-none"
          >

      ...
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/create-workflow?${moduleIdFilter ? `moduleId=${moduleIdFilter}&isTemplate=true` : projectIdFilter ? `projectId=${projectIdFilter}` : ''}`}>
            <button className={`flex items-center gap-2 px-6 py-3 ${isTemplateFilter ? 'bg-indigo-600 hover:bg-indigo-700 shadow-indigo-100' : 'bg-orange-600 hover:bg-orange-700 shadow-orange-100'} text-white rounded-xl font-bold shadow-lg transition-all active:scale-95`}>
              <Plus size={18} />

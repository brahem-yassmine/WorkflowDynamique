    ...
    return (
        <div className="px-4 py-3 shadow-sm rounded-md bg-white border border-slate-200 min-w-[130px]">
            ...
            <div className="flex flex-col items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-cyan-100 flex items-center justify-center text-cyan-600 border border-cyan-200">
                    <GitBranchPlus size={16} />
                </div>
                <div className="text-center">
                    <div className="text-[10px] font-bold text-slate-700 uppercase">{data.label || 'Parallel'}</div>

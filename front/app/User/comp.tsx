...
function UserSidebar() {
  ...
  return (
    <aside className="w-full bg-indigo-700 text-white flex flex-col h-full shadow-2xl relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-indigo-900/20 rounded-full -ml-12 -mb-12"></div>

      <div className="p-8 relative z-10">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center shadow-lg border border-white/10 overflow-hidden">
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute left-0 w-1 h-6 bg-indigo-50 rounded-r-full"
                    />
                  )}
